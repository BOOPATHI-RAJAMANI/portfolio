          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-background/60 border border-border">
              ...
              <form className="space-y-4">
                <div>
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-background/60 border border-border focus:border-primary/50 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all text-foreground placeholder:text-muted-foreground"
                  />
                </div>
                <div>
                  <input
                ...
                <div>
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-3 rounded-xl bg-background/60 border border-border focus:border-primary/50 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all text-foreground placeholder:text-muted-foreground resize-none"
                  />
                </div>
                <motion.button
                  type="submit"
